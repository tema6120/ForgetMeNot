...
object DbKeys {
    ...
    const val CARD_FILTER_FOR_EXERCISE_LIMIT = 31L
    const val CARD_FILTER_FOR_EXERCISE_GRADE_MIN = 32L
    const val CARD_FILTER_FOR_EXERCISE_GRADE_MAX = 33L
    const val CARD_FILTER_FOR_EXERCISE_LAST_TESTED_FROM_TIME_AGO = 34L
    const val CARD_FILTER_FOR_EXERCISE_LAST_TESTED_TO_TIME_AGO = 35L
    const val SHOW_PROGRESS_BAR_IN_EXERCISE = 36L
