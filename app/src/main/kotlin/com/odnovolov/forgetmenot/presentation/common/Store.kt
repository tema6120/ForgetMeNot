...
interface Store {
    ...
    fun loadRepetitionSettingsState(globalState: GlobalState): RepetitionSettings.State
    fun save(repetitionSettingsState: RepetitionSettings.State)
    fun deleteRepetitionSettingsState()
