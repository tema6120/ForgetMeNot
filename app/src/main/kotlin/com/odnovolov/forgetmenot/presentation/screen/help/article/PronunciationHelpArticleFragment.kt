...
import com.odnovolov.forgetmenot.presentation.screen.help.HelpArticle.Pronunciation
import com.odnovolov.forgetmenot.presentation.screen.help.HelpDiScope
import com.odnovolov.forgetmenot.presentation.screen.help.HelpEvent.ArticleOpened
import kotlinx.coroutines.launch

class PronunciationHelpArticleFragment : BaseFragment() {
    init {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view as TextView
        view.setText(R.string.article_pronunciation)
    }
    ...
    override fun onResume() {
        ...
        viewCoroutineScope!!.launch {
            ...
            diScope.controller.dispatch(ArticleOpened(Pronunciation))
        }
    }
}